    ...
    <section id="aboutme-section" className="aboutme-container">
      ...
      <div className="aboutme-container-body">
        ...
        <article>
          <p>
            <br />
            I'm a Frontend Developer with experience in creating web and mobile
            ...
            collaborate with cross-functional teams to create effective
            solutions that meet client requirements and exceed their
            expectations. I'm always on the lookout for new technologies and
            tools to improve my skills and stay up-to-date in the world of web
            development. <br />
          </p>
        </article>
      </div>
